...
fn patterns(style: Style) -> (&'static [&'static [u32]], &'static [&'static [u32]]) {
    match style {
        Style::Classical | Style::Orchestral | Style::Brass | Style::Concerto | Style::Waltz | Style::Rapids | Style::Baroque | Style::Western => (CLASSICAL_PATTERNS_44, CLASSICAL_ENDINGS_44),
